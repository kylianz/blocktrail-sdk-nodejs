...
APIClient.prototype.debugAuth = function(cb) {
    ...
    return self.client.get("/debug/http-signature", null, {auth: RestClient.HTTP_SIGNATURE}, cb);
};
...
APIClient.prototype.initWallet = function(options, cb) {
    ...
    deferred.resolve(self.client.get("/wallet/" + identifier, null, {auth: RestClient.HTTP_SIGNATURE}).then(function(result) {
...
APIClient.prototype.getWalletBalance = function(identifier, cb) {
    ...
    return self.client.get("/wallet/" + identifier + "/balance", null, {auth: RestClient.HTTP_SIGNATURE}, cb);
};
...
APIClient.prototype.doWalletDiscovery = function(identifier, gap, cb) {
    ...
    return self.client.get("/wallet/" + identifier + "/discovery", {gap: gap}, {auth: RestClient.HTTP_SIGNATURE}, cb);
};
...
APIClient.prototype.walletTransactions = function(identifier, params, cb) {
    ...
    return self.client.get("/wallet/" + identifier + "/transactions", params, {auth: RestClient.HTTP_SIGNATURE}, cb);
};
...
APIClient.prototype.walletAddresses = function(identifier, params, cb) {
    ...
    return self.client.get("/wallet/" + identifier + "/addresses", params, {auth: RestClient.HTTP_SIGNATURE}, cb);
};
...
APIClient.prototype.walletUTXOs = function(identifier, params, cb) {
    ...
    return self.client.get("/wallet/" + identifier + "/utxos", params, {auth: RestClient.HTTP_SIGNATURE}, cb);
};
...
APIClient.prototype.allWallets = function(params, cb) {
    ...
    return self.client.get("/wallets", params, {auth: RestClient.HTTP_SIGNATURE}, cb);
};
...
APIClient.prototype.price = function(cb) {
    ...
    return self.client.get("/price", null, cb);
};
